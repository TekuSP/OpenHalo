...
{
    public class PausedState : HaloWindow
    {
        private string currentState;
        public PausedState(OpenHaloApplication app) : base(app)
        {
        }
        ...
        public override void RenderElements()
        {
            ...
            Text M117 = new Text(OpenHaloApplication.NinaBFont, "Print paused");
            ...
            Image image = new Image(Resources.ResourceDictionary.GetBitmap(ResourceDictionary.BitmapResources.pause));
            ...
            Text printFinished = new Text(OpenHaloApplication.SegoeUI24, "Print paused");
            ...
            ellipse.Fill = new SolidColorBrush(System.Drawing.Color.Yellow);
            ellipse.Visibility = Visibility.Visible;
            ellipse.Stroke = new Pen(System.Drawing.Color.Yellow);
