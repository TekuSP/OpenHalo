...
{
    public class StandbyState : HaloWindow
    {
        private string currentState;
        public StandbyState(OpenHaloApplication app) : base(app)
        {
        }
        ...
        public override void RenderElements()
        {
            ...
            Text M117 = new Text(OpenHaloApplication.NinaBFont, "Ready");
            ...
            Image image = new Image(Resources.ResourceDictionary.GetBitmap(ResourceDictionary.BitmapResources.ready));
            ...
            Text printFinished = new Text(OpenHaloApplication.SegoeUI24, "Ready");
            ...
            ellipse.Fill = new SolidColorBrush(System.Drawing.Color.LightGray);
            ellipse.Visibility = Visibility.Visible;
            ellipse.Stroke = new Pen(System.Drawing.Color.LightGray);
